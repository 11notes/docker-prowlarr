...
# PROWLARR
![size](https://img.shields.io/badge/image_size-177MB-green?color=%2338ad2d)![5px](https://raw.githubusercontent.com/11notes/static/refs/heads/master/img/markdown/transparent5x2px.png)![pulls](https://img.shields.io/docker/pulls/11notes/prowlarr?color=2b75d6)![5px](https://raw.githubusercontent.com/11notes/static/refs/heads/master/img/markdown/transparent5x2px.png)[<img src="https://img.shields.io/github/issues/11notes/docker-prowlarr?color=7842f5">](https://github.com/11notes/docker-prowlarr/issues)![5px](https://raw.githubusercontent.com/11notes/static/refs/heads/master/img/markdown/transparent5x2px.png)![swiss_made](https://img.shields.io/badge/Swiss_Made-FFFFFF?labelColor=FF0000&logo=data:image/svg%2bxml;base64,)

run Prowlarr rootless.

# INTRODUCTION 📢

[Prowlarr](https://github.com/Prowlarr/Prowlarr) (created by [Prowlarr](https://github.com/Prowlarr)) is an indexer manager/proxy built on the popular *arr .net/reactjs base stack to integrate with your various PVR apps. Prowlarr supports management of both Torrent Trackers and Usenet Indexers. It integrates seamlessly with Lidarr, Mylar3, Radarr, Readarr, and Sonarr offering complete management of your indexers with no per app Indexer setup required (we do it all).

# SYNOPSIS 📖
**What can I do with this?** This image will give you a [rootless](https://github.com/11notes/RTFM/blob/main/linux/container/image/rootless.md) and lightweight Prowlarr installation for your adventures on the high seas *arrrr*!
...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/prowlarr | 177MB | 1000:1000 | ❌ | amd64, arm64, armv7 |
| home-operations/prowlarr | 182MB | 65534:65533 | ❌ | amd64, arm64 |
| linuxserver/prowlarr | 193MB | 0:0 | ❌ | amd64, arm64 |
| hotio/prowlarr | 240MB | 0:0 | ❌ | amd64, arm64 |
...
* [2.3.5](https://hub.docker.com/r/11notes/prowlarr/tags?name=2.3.5)
* [2.3.5-unraid](https://hub.docker.com/r/11notes/prowlarr/tags?name=2.3.5-unraid)
* [2.3.5-nobody](https://hub.docker.com/r/11notes/prowlarr/tags?name=2.3.5-nobody)

### There is no latest tag, what am I supposed to do about updates?
It is my opinion that the ```:latest``` tag is a bad habbit and should not be used at all. Many developers introduce **breaking changes** in new releases. This would messed up everything for people who use ```:latest```. If you don’t want to change the tag to the latest [semver](https://semver.org/), simply use the short versions of [semver](https://semver.org/). Instead of using ```:2.3.5``` you can use ```:2``` or ```:2.3```. Since on each new version these tags are updated to the latest version of the software, using them is identical to using ```:latest``` but at least fixed to a major or minor version. Which in theory should not introduce breaking changes.

If you still insist on having the bleeding edge release of this app, simply use the ```:rolling``` tag, but be warned! You will get the latest version of the app instantly, regardless of breaking changes or security issues or what so ever. You do this at your own risk!

# REGISTRIES ☁️
```
docker pull 11notes/prowlarr:2.3.5
docker pull ghcr.io/11notes/prowlarr:2.3.5
docker pull quay.io/11notes/prowlarr:2.3.5
```
...
*created 08.05.2026, 11:39:44 (CET)*